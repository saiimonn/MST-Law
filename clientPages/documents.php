...
$query = "SELECT a.id, a.date as appointment_date, a.description, u.name as attorney_name,
        ...
        <div class="documents-container">
            <?php if (isset($_GET['error'])): ?>
                <div class="alert alert-danger">
                    ...
                    switch($_GET['error']) {
                        case 'type':
                            echo "Invalid file type. Only PDF, DOC, DOCX files are allowed.";
                            break;
                        case 'size':
                            ...
                            <?php if (!empty($appointment['documents'])): ?>
                                <?php foreach ($appointment['documents'] as $document): ?>
                                    <div class="document-item">
                                        ...
                                        <a href="../includes/download.php?id=<?php echo htmlspecialchars($document['id']); ?>" 
